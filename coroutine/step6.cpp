/* Author: lipixun
 * Created Time : 2024-06-18 11:20:38
 *
 * File Name: step6.cpp
 * Description:
 *
 *  Step 6: Fix a bug of step5, but still have segment fault.
 *
 */
 ...
 public:
  ...
  class Promise {
   public:
    ...
    std::suspend_never final_suspend() noexcept { return {}; }  // Haha, here is the issue.
